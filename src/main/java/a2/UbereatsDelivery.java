...
/**
 * This is the UbereatsDelivery class. The UbereatsDelivery class extends the Delivery class and
 * inherits all of its characteristics. The UbereatsDelivery class can output its delivery details
 * in JSON format.
 */
