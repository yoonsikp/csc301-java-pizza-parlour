...
/**
 * This is the DeliveryHandler class. A DelveryHandler contains methods for interacting with all
 * Delivery objects. It makes the interface between Deliveries and the pizza parlour program more
 * transparent and easy to use.
 */
class DeliveryHandler {

  /**
   * A List of all available delivery methods for the restaurant
   */
  ...
  /**
   * Creates a Delivery object or type <delivType> for the order <currOrder> using the provided
   * address
   *
  ...
  /**
   * Returns formatted delivery details for the delivery belonging to order depending on the
   * delivery type. If the delivery type is Ubereats, the returned is a JSON object, if the delivery
   * is Foodora, the returned is a CSV object, and if the delivery type is House, the returned is a
   * text representation of the delivery.
   *
