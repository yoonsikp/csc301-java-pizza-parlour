...
/**
 * This is the DeliveryHandler class. A DelveryHandler contains methods for interacting with all Delivery objects.
 * It makes the interface between Deliveries and the pizza parlour program more transparent and easy to use.
 */
