...
/**
 * This is the Delivery class. It is an abstract class and contains both abstract and non-abstract attributes and
 * methods that can be used and/or implemented in extending classes. A Delivery has an address, a type and an
 * orderID that represents the Order the Delivery is for.
 */
