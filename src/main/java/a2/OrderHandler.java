...
public class OrderHandler {
    ...
    /**
     * Creates the order with the nextOrderID and adds it to the
     * HashMap of all orders.
    ...
    /**
     * Get the orderID to be used for the next order and then
     * increment nextOrderID in preparation for the next order.
