...
/**
 * This is the PizzaParlour class.
 * A PizzaParlour represents the entire restaurant, and has a Menu, and an OrderHandler and DeliveryHandler, which are
 * used to transparently interact with Order functionalities and Delivery functionalities, respectively.
 */
class PizzaParlour {
    ...
    /**
     * Main method that starts the entire pizza parlous process. This method calls the Menu parser in MenuLoader,
     * instantiates the handlers, instantiates terminal interface by calling its first constructor, and then starts
