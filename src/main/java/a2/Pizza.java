...
/**
 * This is the Pizza class. A Pizza is a Food object that has a specific type, size, toppings and
 * price.
 */
class Pizza extends Food {
  ...
  /**
   * Constructor for a Pizza object, which extends a Food object, uses a Builder design pattern to
   * avoid constructor tunneling. Creates a Pizza with a provided type, size, toppings and price.
   *
  ...
  public static class Builder extends Food.FoodBuilder<Builder> {
    ...
    /**
     * Build the desired Pizza type depending on the builder's type. Returns an Pizza with size and
     * toppings declared, and returns a Pizza with size m if no size is declared.
     *
