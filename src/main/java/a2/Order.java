 ...
 * An Order has a distinguishing orderID, a List of Foods in the Order, the total price of the Order,
 * and an associated Delivery.
 */
class Order {
    ...
    /**
     * Setter for this Order's Delivery, takes a Delivery object and sets this Order's delivery field to it.
     *
    ...
    /**
     * Returns a string representation of this Order, including all foods in this Order and the final price of this Order.
     *
