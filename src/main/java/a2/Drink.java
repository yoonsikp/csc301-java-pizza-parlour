 ...
 * A Drink is a Food object that has a specific type and price.
 */
public class Drink extends Food {
    /**
     * Constructor for a Drink object, which extends a Food object, uses a Builder design pattern to avoid constructor
     * tunneling. Creates a Drink with a provided type and price.
     *
    ...
    public static class Builder extends Food.FoodBuilder<Builder> {
        ...
        /**
         * Builds a new Drink obkect by calling Drink's constructor, and providing an instance of the Builder class
         * that has the desired type and price.
         *
