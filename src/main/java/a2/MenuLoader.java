...
/**
 * This is the MenuLoader class. The MenuLoader is used to read from a JSON file that stores
 * persistent data about the menu available in the pizza parlour, and creates and populates a Menu
 * object that contains all that information.
 */
class MenuLoader {

  /**
   * Creates and populates a Menu object by reading a JSON file and parsing it using GSON library.
   * Populates the ' menu with all items on the menu and returns it.
   *
