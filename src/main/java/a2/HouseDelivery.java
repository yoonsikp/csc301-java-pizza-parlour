...
/**
 * This is the HouseDelivery class.
 * The HouseDelivery class extends the Delivery class and inherits all of its characteristics.
 * The HouseDelivery class can output its delivery details in text format.
 */
